...
use buffer_pool_manager::page::{SlottedPage, PageType};
use std::sync::Arc;
...
impl TableHeap {
    ...
    fn initialize_page(slotted_page: &mut SlottedPage) {
        let header = buffer_pool_manager::page::PageHeader {
            page_id: 0,
        ...
        slotted_page.set_header(&header);
    }
    ...
    pub fn insert_tuple(&self, tuple: &Tuple) -> Option<RowId> {
        ...
        loop {
            ...
            if next_page_id == INVALID_PAGE_ID {
                ...
                let mut header = slotted_page.header();
    ...
    /// Returns the ID of the first page in the table heap.
